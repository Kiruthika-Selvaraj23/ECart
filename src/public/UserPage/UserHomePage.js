      ...
      <div className='bg-gradient-to-tr from-blue-100 to-white min-h-[100vh] p-5'>
        <div className='sm:flex sm:justify-between mx-10 sm:mx-16'>
          <div className='sm:flex sm:flex-col sm:justify-center sm:items-center'>
            ...
            <button className='text-[13px] sm:text-[15px] bg-gradient-to-t from-blue-950 to-blue-400 w-[80px] sm:w-[100px] font-semibold p-2 rounded-[5px] text-white mt-2 sm:mt-5'>Shop Now</button>
          </div>

    ...
    <div className='mx-5 sm:mx-20 my-12'>
      ...
      <ul className='flex justify-between flex-wrap'>
        <li className='bg-orange-50 rounded-md p-3 text-center m-2 sm:max-w-[43%] lg:max-w-[35%] xl:max-w-[30%]'>
          ...
          <button onClick={() => navigate("/userShopPage")} className='text-[13px] sm:text-[15px] lg:text-[17px] p-2 text-white rounded-[5px] font-semibold bg-gradient-to-t from-blue-800 to-blue-500 my-2 sm:my-4'>Shop Now</button>
        </li>
      ...
      <ul className='flex justify-between flex-wrap lg:flex-nowrap'>
        <li className='bg-orange-50 flex justify-between p-3 rounded-md md:max-w-[45%] lg:max-w-[30%] m-3'>
          <div className='flex flex-col justify-center items-center'>
            ...
            <button className='text-[13px] sm:text-[15px] lg:text-[17px] text-orange-600 border-[1px] border-orange-600 p-2 rounded-full my-4'>Grab Now</button>
          </div>
        ...
        <li className='bg-blue-200 flex justify-between p-3 rounded-md md:max-w-[45%] lg:max-w-[30%] m-3'>
          <div className='flex flex-col justify-center items-center'>
            ...
            <button className='text-[13px] sm:text-[15px] lg:text-[17px] text-blue-900 border-[1px] border-blue-900 p-2 rounded-full my-4'>Explore them</button>
          </div>
        ...
        <li className='bg-green-50 flex justify-between p-3 rounded-md md:max-w-[45%] lg:max-w-[30%] m-3'>
          <div className='flex flex-col justify-center items-center'>
            ...
            <button className='text-[13px] sm:text-[15px] lg:text-[17px] text-green-900 border-[1px] border-green-900 p-2 rounded-full my-4'>Shop Now</button>
          </div>
      ...
      <div className='flex flex-col lg:flex-row justify-between px-10 my-7 border-[1px] border-dotted border-gray-800 p-3'>
        ...
        <div className='flex'>
          ...
          <button className='group text-[13px] sm:text-[15px] lg:text-[17px] p-2 text-white rounded-[5px] font-semibold bg-blue-700 my-4 flex'>Subscribe

                      ...
                      <div className='ml-10'>
                              ...
                              {productDetails[0]?.quantity !== 0 ? (
                                  <div className='flex'>
                                    <div className='flex p-1 text-green-800 bg-green-100 w-[100px]'>
                                        ...
                                        <p className='font-semibold text-[17px] ml-1'>In Stock</p>
                                      </div>
                                      <p className='text-[20px] text-gray-600 font-semibold ml-3'>Free Delivery within 1 Week</p>
                                  </div>
                              ) : (
                          ...
                          <div className='flex justify-between w-[50%] mt-2'>
                              <div className='bg-white rounded-md shadow-2xl shadow-gray-900 p-2 flex'>
                                  ...
                                  <p className='text-gray-500 font-semibold ml-1'>7 Days Return</p>
                              </div>
                              <div className='bg-white rounded-md shadow-2xl shadow-gray-900 p-2 flex'>

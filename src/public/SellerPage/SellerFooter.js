        ...
        <footer className='bg-blue-950'>
            <div className='mx-20 p-3 text-white flex justify-between'>
                <div>
                    ...
                    <p className='text-[15px] text-slate-300'>Products</p>
                    <p className='text-[15px] text-slate-300'>Orders</p>
                </div>

                <div>
                    <h2 className='font-semibold italic text-[20px] mb-3'>Customer Services</h2>
                    <p className='text-[15px] text-slate-300'>Help Center</p>
                    <p className='text-[15px] text-slate-300'>Shipping info</p>
                    <p className='text-[15px] text-slate-300'>Return Policy</p>
                </div>

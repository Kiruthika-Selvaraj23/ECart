        ...
        <footer className='bg-blue-950'>
            <div className='mx-5 sm:mx-10 lg:mx-20 pb-10 p-3 text-white sm:flex sm:justify-between'>
                ...
                <div className="mt-2 sm:mt-0">
                    <h2 className='font-semibold italic text-[17px] lg:text-[20px] mb-1 sm:mb-3'>Quick Links</h2>
                ...
                <div className="mt-2 sm:mt-0">
                    <h2 className='font-semibold italic text-[17px] lg:text-[20px] mb-1 sm:mb-3'>Support</h2>
                ...
                <div className='mt-2 sm:mt-0 flex flex-col'>
                    <h2 className='font-semibold italic text-[17px] lg:text-[20px] mb-1 sm:mb-5'>Stay Connected</h2>
                    <div className='flex sm:justify-between items-center'>
                        <img className='h-[26px] lg:h-[30px]' src={FacebookLogo} alt="facebook" />
                        <img className='h-[26px] lg:h-[30px] mx-2' src={TwitterLogo} alt="twitter" />
                        <img className='h-[26px] lg:h-[30px]' src={InstagramLogo} alt="instagram" />
                    </div>
                </div>

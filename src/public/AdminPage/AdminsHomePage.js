              ...
              <div className='mx-20 mt-[90px]'>
                  <div className='flex justify-between'>
                      <div className='flex flex-col justify-center'>
                          <h1 className='text-[30px] font-bold italic'>Welcome to <span className='text-blue-900'>eCart</span> Admin!</h1>
                          <p className='text-[20px] font-semibold text-gray-600'>Effectiently manage your e-commerce store with ECart. Monitor, track and grow your business</p>
                      </div>
                      <img className='h-[300px] w-[60%]' src={AdminHomeImage} alt='admin' />
                  </div>
                  ...
                  <div>
                      <h1 className='text-blue-700 text-[25px] font-semibold'>Manage Your Store with ECart</h1>
                      <p className='text-gray-600 text-[17px] font-semibold'>ECart helps you easily manage your online store with powerful tools to optimize sales and streamline operations.</p>
                      ...
                      <div className='my-9 text-center'>
                          <h1 className='text-blue-700 text-[25px] font-semibold'>Empower Your Business with ECart</h1>
                          <p className='text-gray-600 text-[17px] font-semibold'>Empower Your Business with the powerful and easy-to-use admin tools of ECart.</p>
                          <div className='flex justify-between mt-4'>
                              <div className='flex justify-center w-[25%] bg-white p-2 rounded-md shadow-2xl shadow-slate-700 m-2'>

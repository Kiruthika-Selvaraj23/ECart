            ...
            <div className='sm:flex p-3 bg-white rounded-md  min-w-[90%] sm:max-w-[90%] lg:min-w-[55%] my-7'>
                ...
                <div className='w-[80%] sm:w-[58%]'>
                    ...
                    <form onSubmit={(event) => submitRegister(event)} className='flex flex-col mb-7'>
                        ...
                        <div>
                            <button type='submit' className='text-[12px] sm:text-[15px] bg-gradient-to-t from-blue-950 to-blue-500 w-[80px] sm:w-[100px] font-semibold p-2 rounded-[5px] text-white mt-5'>Submit</button>
                        </div>
                    </form>
                 </div>
           </div>

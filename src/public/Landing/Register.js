...
export default function Register() {
    ...
    return (
        <div className='flex justify-center items-center'>
            <div className='sm:flex p-3 bg-white rounded-md  min-w-[90%] sm:max-w-[90%] lg:min-w-[55%] my-7'>
                <img className='h-[450px] hidden sm:block md:h-[500px] w-[60%]' src={RegisterImage} alt="regiter" />
                <div className='w-[80%] sm:w-[58%]'>
                    <h1 className='text-[20px] sm:text-[25px] md:text-[30px] text-blue-700 italic font-semibold'>Register</h1>
                    <form onSubmit={(event) => submitRegister(event)} className='flex flex-col mb-7'>
                        <label className='text-gray-600 text-[15px] lg:text-[17px] font-semibold my-3' htmlFor='name'>Name:</label>
                        ...
                        <label className='text-gray-600 text-[15px] lg:text-[17px] font-semibold my-3' htmlFor='pass'>Password:</label>
                        ...
                        <label className='text-gray-600 text-[15px] lg:text-[17px] font-semibold my-3' htmlFor='mobileNo'>Mobile Number:</label>
                        ...
                        {showCompanyInput === "seller" ?
                            (<>
                                <label className='text-gray-600 text-[15px] lg:text-[17px] font-semibold my-3' htmlFor='mobileNo'>Company Name:</label>
                        ...
                        <div>
                            <button type='submit' className='text-[12px] sm:text-[15px] lg:text-[17px] bg-gradient-to-t from-blue-950 to-blue-500 w-[80px] sm:w-[100px] font-semibold p-2 rounded-[5px] text-white mt-5'>Submit</button>
                        </div>
                    </form>
                 </div>
           </div>

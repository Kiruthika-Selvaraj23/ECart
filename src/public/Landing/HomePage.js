        ...
        <ul className='flex justify-center items-center my-10'>
            {
                registrationCardDatas.map(eachItem => (
                    <li key={eachItem.id} className='bg-slate-100 p-3 rounded-md shadow-2xl shadow-gray-600 max-w-[30%] m-4'>
                        <img className='h-[250px] w-full' src={eachItem.image} alt="seller" />
                        <h1 className='text-blue-700 font-semibold italic text-[20px] text-center mb-3'>{eachItem.heading}</h1>
                        <p className='text-gray-600 font-semibold text-[15px] mb-5'>{eachItem.desc}</p>
                        <div className='flex justify-center items-center'>
                            <button onClick={() => clickRegistartion(eachItem.id)} className='bg-blue-900 text-white rounded-[3px] p-2 font-semibold'>Register Now</button>
                        </div>
                    </li>
                ))
           }
        ...
        <section>
            ...
            <div className="bg-blue-50 min-h-[100vh] p-3">
                ...
                <div className='text-center mt-7'>
                    <h1 className='text-[50px] text-blue-950 font-bold italic'>Welcome to eCart!</h1>
                    <p className='text-[20px] text-blue-900 font-semibold mt-2'>Your Non-Stop Online Shopping Destination</p>
                    <p className='text-[20px] text-blue-900 font-semibold mt-2'>Shop thousands of products, enjoy exclusive deals, and experience fast and secure delivery with ECart.</p>
                    <ul className='flex justify-center items-center text-gray-500 text-[15px] font-semibold'>
